// GENERATE BY ./scripts/generate.ts
    // DON NOT EDIT IT MANUALLY
      ...
      const TargetColored = React.forwardRef<HTMLSpanElement, Omit<DMIconProps, 'icon'>>((props, ref) => {
