// GENERATE BY ./scripts/generate.ts
    // DON NOT EDIT IT MANUALLY
      ...
      const LessThanOutlined = React.forwardRef<HTMLSpanElement, Omit<DMIconProps, 'icon'>>((props, ref) => {
    ...
    React.createElement("path", { d: "M11.88 2.55 4.091 7l7.787 4.45-.579 1.013L1.741 7l9.56-5.463z" })))
        } />;
      })

      export default LessThanOutlined;