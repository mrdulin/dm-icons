// GENERATE BY ./scripts/generate.ts
    // DON NOT EDIT IT MANUALLY
      ...
      const LayoutOneOutlined = React.forwardRef<HTMLSpanElement, Omit<DMIconProps, 'icon'>>((props, ref) => {
    ...
    React.createElement("rect", { width: 18, height: 18, fill: "currentColor", rx: 1 })))
        } />;
      })

      export default LayoutOneOutlined;