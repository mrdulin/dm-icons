// GENERATE BY ./scripts/generate.ts
    // DON NOT EDIT IT MANUALLY
      ...
      const LayoutSixOutlined = React.forwardRef<HTMLSpanElement, Omit<DMIconProps, 'icon'>>((props, ref) => {
    ...
    React.createElement("g", { fill: "currentColor" },
        ...
        React.createElement("rect", { width: 4.5, height: 8, rx: 1 }),
        React.createElement("rect", { width: 4.5, height: 8, x: 13.5, y: 10, rx: 1 }),
        React.createElement("rect", { width: 4.5, height: 8, x: 13.5, rx: 1 }),
        React.createElement("rect", { width: 4.5, height: 8, x: 6.75, y: 10, rx: 1 }),
        React.createElement("rect", { width: 4.5, height: 8, x: 6.75, rx: 1 }))))
        } />;
      })

      export default LayoutSixOutlined;