// GENERATE BY ./scripts/generate.ts
    ...
    React.createElement("g", { transform: "translate(0 13)" },
        React.createElement("path", { d: "M32 48.5a8.5 8.5 0 1 1 0-17 8.5 8.5 0 0 1 0 17m0-3a5.5 5.5 0 1 0 0-11 5.5 5.5 0 0 0 0 11" }),
        React.createElement("circle", { cx: 35, cy: 3, r: 3 }),
        React.createElement("path", { d: "M9 52.5h4.002c.827 0 1.498.666 1.498 1.5 0 .828-.675 1.5-1.498 1.5H9v4.002C9 60.329 8.334 61 7.5 61c-.828 0-1.5-.675-1.5-1.498V55.5H1.998A1.495 1.495 0 0 1 .5 54c0-.828.675-1.5 1.498-1.5H6v-4.002C6 47.671 6.666 47 7.5 47c.828 0 1.5.675 1.5 1.498z" })),
    React.createElement("g", { transform: "translate(135)" },
        React.createElement("circle", { cx: 6, cy: 3, r: 3 }),
        React.createElement("circle", { cx: 30, cy: 59, r: 3 }),
        React.createElement("path", { d: "M9 77.5h4.002c.827 0 1.498.666 1.498 1.5 0 .828-.675 1.5-1.498 1.5H9v4.002C9 85.329 8.334 86 7.5 86c-.828 0-1.5-.675-1.5-1.498V80.5H1.998A1.495 1.495 0 0 1 .5 79c0-.828.675-1.5 1.498-1.5H6v-4.002C6 72.671 6.666 72 7.5 72c.828 0 1.5.675 1.5 1.498z" }),
        React.createElement("rect", { width: 2, height: 9, rx: 1, transform: "translate(24 17)" })),
    React.createElement("path", { d: "M123.361 98.752H58.798C56.7 98.752 55 97.064 55 94.98V15.772C55 13.688 56.7 12 58.798 12h45.574l22.787 22.631v60.35c0 2.083-1.7 3.771-3.798 3.771" }),
    React.createElement("path", { d: "M104.372 12v18.86c0 2.083 1.7 3.771 3.798 3.771h18.989z" }),
    React.createElement("g", { transform: "translate(69.558 26.459)" },
        React.createElement("path", { d: "M41.055 31.23H2.62C1.136 31.23 0 30.104 0 28.629s1.136-2.602 2.62-2.602h38.435c1.485 0 2.62 1.127 2.62 2.602s-1.135 2.603-2.62 2.603M23.585 5.206H2.62C1.136 5.205 0 4.077 0 2.603 0 1.128 1.136 0 2.62 0h20.965c1.485 0 2.62 1.128 2.62 2.603 0 1.474-1.135 2.602-2.62 2.602m17.47 39.039H2.62C1.136 44.244 0 43.116 0 41.64s1.136-2.603 2.62-2.603h38.435c1.485 0 2.62 1.128 2.62 2.603s-1.135 2.603-2.62 2.603M28.127 57.256H2.795c-1.485 0-2.62-1.127-2.62-2.602s1.135-2.603 2.62-2.603h25.332c1.485 0 2.62 1.128 2.62 2.603s-1.135 2.602-2.62 2.602" }),
