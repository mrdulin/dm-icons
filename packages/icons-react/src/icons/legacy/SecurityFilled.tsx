// GENERATE BY ./scripts/generate.ts
    ...
    React.createElement("path", { fill: "currentColor", d: "M17.277 3.33a12.8 12.8 0 0 1-.967 2.288v7.525h-1.056V7.246c-.32.418-.66.814-1.024 1.2l-.34-1.112c1.077-1.276 1.881-2.76 2.398-4.454z" }),
    React.createElement("path", { fill: "currentColor", fillRule: "evenodd", d: "M23.064 7.07h-2.156v.968h3.08v1.013h-2.145c.572.99 1.353 1.858 2.353 2.606l-.681.913c-1.012-.946-1.848-2.111-2.519-3.52h-.088v4.07h-1.034V9.05h-.1q-1.039 2.26-2.573 3.531l-.595-.945c.946-.66 1.717-1.518 2.332-2.585h-2.035V8.038h2.971V7.07H17.74V3.42h5.324zm-4.29-1h3.255V4.42h-3.256z", clipRule: "evenodd" }),
