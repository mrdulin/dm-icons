// GENERATE BY ./scripts/generate.ts
    // DON NOT EDIT IT MANUALLY
      ...
      const InterestRateNewsOutlined = React.forwardRef<HTMLSpanElement, Omit<DMIconProps, 'icon'>>((props, ref) => {
