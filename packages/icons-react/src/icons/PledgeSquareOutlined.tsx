// GENERATE BY ./scripts/generate.ts
    ...
    React.createElement("path", { fill: "currentColor", d: "M9.611 8.61c-.132 1.298-.528 2.3-1.21 2.982-.682.693-1.738 1.242-3.157 1.638l-.56-.967c1.275-.308 2.222-.737 2.827-1.298.605-.572.968-1.376 1.089-2.421zM9.59 10.733c1.21.43 2.3.958 3.289 1.574l-.572.901a15.5 15.5 0 0 0-3.245-1.693z" }),
    React.createElement("path", { fill: "currentColor", d: "M12.384 4.001c-2.2.374-4.676.595-7.404.639v.813h3.455c.044-.297.077-.583.11-.869l1.045.133a15 15 0 0 1-.088.736h3.365v.968h-3.53c-.066.275-.122.54-.188.804h2.784v3.839h-1.001V8.192H6.828v2.882h-1v-3.85h2.266c.066-.274.12-.54.176-.803H4.98v.837c-.055 2.463-.527 4.421-1.43 5.895l-.726-.77c.704-1.231 1.09-2.948 1.155-5.125V3.76q4.422-.05 7.887-.694z" }),
