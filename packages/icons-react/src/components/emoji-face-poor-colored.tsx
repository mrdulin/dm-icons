...
const SvgEmojiFacePoorColored = ({
  ...
  >
    ...
    <circle cx={26} cy={25} r={19} fill="url(#a)" />
    <circle cx={26} cy={25} r={19} fill="url(#b)" />
    <circle cx={26} cy={25} r={17} fill="url(#c)" />
    <path
      fill="#6C4325"
    ...
    />
    <path fill="url(#d)" d="M8 24h35v10.5H8z" />
    <ellipse cx={12} cy={38.5} fill="url(#e)" rx={5} ry={5.5} />
    <path fill="url(#f)" d="M6 32h11.5v11.5H6z" />
    <ellipse
      cx={5}
      cy={5.5}
      fill="url(#g)"
    ...
    <defs>
      ...
      >
        <use xlinkHref="#i" transform="scale(.01429 .04762)" />
      </pattern>
      <pattern
        id="f"
        width={1}
        ...
        patternContentUnits="objectBoundingBox"
      >
        <use xlinkHref="#j" transform="scale(.04348)" />
      </pattern>
      <pattern
        id="h"
        width={1}
